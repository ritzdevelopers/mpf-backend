    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AdminAuditLoggingFilter adminAuditLoggingFilter)
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/admin-portal/auth/session").authenticated()
                        .requestMatchers("/api/v1/auth/admin-permission-definitions").authenticated()
                        .requestMatchers("/api/v1/admin-portal/auth/admin-permission-definitions")
                                .authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/unlock-enquiries")
                                .hasAnyRole("SUPERADMIN", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/admin-portal/auth/unlock-enquiries")
                                .hasAnyRole("SUPERADMIN", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/auth/enquiry-access-status")
                                .hasAnyRole("SUPERADMIN", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/admin-portal/auth/enquiry-access-status")
                                .hasAnyRole("SUPERADMIN", "ADMIN")
                        /** Cookie-based refresh of access token (no Bearer header required). */
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/refresh-token").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/app/auth/refresh-token").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/admin-portal/auth/refresh-token")
                                .permitAll()
                        .requestMatchers("/api/v1/auth/refresh").authenticated()
                        .requestMatchers("/api/v1/app/auth/refresh").authenticated()
                        .requestMatchers("/api/v1/admin-portal/auth/refresh").authenticated()
                        .requestMatchers("/api/v1/auth/logout").permitAll()
                        .requestMatchers("/api/v1/app/auth/logout").permitAll()
                        .requestMatchers("/api/v1/admin-portal/auth/logout").permitAll()
